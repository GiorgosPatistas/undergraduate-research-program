...
REST_FRAMEWORK = {
    ...
    # Pagination — applied only to views that opt in via pagination_class
...
ML_SERVICE_SECRET_KEY = config('ML_SERVICE_SECRET_KEY', default='smarthealthcare-internal-secret-2024')
